...
SOURCEFILES_QUOTED_IF_SPACED=main.c init.c motor/servo.c motor/motor.c interrupts.c utils/time.c utils/uart.c printf/printf.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/init.o ${OBJECTDIR}/motor/servo.o ${OBJECTDIR}/motor/motor.o ${OBJECTDIR}/interrupts.o ${OBJECTDIR}/utils/time.o ${OBJECTDIR}/utils/uart.o ${OBJECTDIR}/printf/printf.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/init.o.d ${OBJECTDIR}/motor/servo.o.d ${OBJECTDIR}/motor/motor.o.d ${OBJECTDIR}/interrupts.o.d ${OBJECTDIR}/utils/time.o.d ${OBJECTDIR}/utils/uart.o.d ${OBJECTDIR}/printf/printf.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/init.o ${OBJECTDIR}/motor/servo.o ${OBJECTDIR}/motor/motor.o ${OBJECTDIR}/interrupts.o ${OBJECTDIR}/utils/time.o ${OBJECTDIR}/utils/uart.o ${OBJECTDIR}/printf/printf.o

# Source Files
SOURCEFILES=main.c init.c motor/servo.c motor/motor.c interrupts.c utils/time.c utils/uart.c printf/printf.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/pArm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/pArm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG=__DEBUG   -omf=elf -DPRINTF_INCLUDE_CONFIG_H -fast-math -DXPRJ_recording=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -std=gnu99     -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D__DEBUG=__DEBUG,,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST)  -mdfp="${DFP_DIR}/xc16" 
